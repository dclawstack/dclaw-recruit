...
**DClaw Recruit** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8040` (FastAPI)
- **Frontend Port:** `3040` (Next.js)
- **Database:** `dclaw_recruit` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3040`
