  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-pink-600/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-purple-600/5 rounded-full blur-3xl" />
      </div>
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Start hiring smarter with AI in 60 seconds</p>
        </div>
        ...
        <div className="bg-card/40 border border-border/50 rounded-2xl p-8 backdrop-blur-sm">
          ...
          <p className="text-xs text-muted-foreground text-center mt-5">
            ...
            <Link href="/login" className="text-pink-400 hover:text-pink-300 font-medium">Sign in</Link>
          </p>
        </div>
