...
date: 2026-05-16
app_id: recruit
app_name: DClaw Recruit
category: Talent
status: Future
---

# 📘 DClaw Recruit — Revised PRD v2.3
...
| **Name** | DClaw Recruit |
| **Category** | Talent |
| **Tagline** | Job posting, candidates |
| **Color** | #EC4899 |
| **Phase** | Future |
| **Port (Frontend Dev)** | 3095 (TBD — assign before build) |
| **Port (Backend Dev)** | 18165 (TBD — assign before build) |
...
|---|---------|-------------|--------------|---------------------|
| P0.1 | **AI Recruit Copilot** | Write job descriptions, screen resumes, and schedule interviews. | LLM JD generation + resume-scoring + scheduling | Generate JD in <2min; rank 100 resumes; auto-schedule |
| P0.2 | **Applicant Tracking** | Pipeline management from source to hire with AI scoring. | AI candidate-scoring + pipeline-velocity prediction | Track 1000 candidates; predict time-to-hire; source effectiveness |
| P0.3 | **Interview Scheduling** | Auto-schedule interviews considering timezone and preferences. | AI scheduling-optimization + conflict resolution | Schedule 3 interviewers + candidate; handle timezones; reminders |
| P0.4 | **Offer Management** | Generate offers, track acceptance, and manage negotiations. | AI offer-comparison + acceptance-prediction | Generate offer in <1min; compare to market; predict acceptance |
...
| # | Feature | Description | AI Component | Acceptance Criteria |
|---|---------|-------------|--------------|---------------------|
| P1.1 | **Sourcing Automation** | Find passive candidates on LinkedIn, GitHub, and job boards. | AI sourcing + personalized outreach generation | Discover 50 candidates per role; auto-send personalized InMail |
| P1.2 | **Interview Intelligence** | Record, transcribe, and analyze interviews for bias and quality. | Whisper + LLM bias-detection + structured-feedback | Transcribe interviews; detect 5 bias types; generate scorecards |
| P1.3 | **Talent Pool** | Build and nurture talent pools for future roles. | AI talent-segmentation + engagement-scoring | Segment 1000 contacts; auto-nurture campaigns; engagement scoring |
| P1.4 | **Employer Branding** | Track and improve employer brand across review sites. | AI sentiment analysis + review-response generation | Monitor Glassdoor/Indeed; auto-respond to reviews; track NPS |
...
| # | Feature | Description | AI Component | Acceptance Criteria |
|---|---------|-------------|--------------|---------------------|
| P2.1 | **Diversity Sourcing** | Ensure diverse candidate slates with AI-powered sourcing. | AI diverse-candidate sourcing + bias-mitigation | Ensure 30%+ diverse slate; anonymize screening; track outcomes |
| P2.2 | **Employee Referrals** | Manage referral program with AI-powered matching. | AI referrer-candidate matching + reward optimization | Match employees to open roles; track referrals; calculate ROI |
| P2.3 | **Onboarding Integration** | Hand off hired candidates to DClaw Onboard seamlessly. | API sync + automated handoff workflow | Auto-create onboarding record; sync documents; schedule Day 1 |
| P2.4 | **Recruitment Analytics** | Dashboard of time-to-fill, cost-per-hire, and quality-of-hire. | AI quality-of-hire prediction + source optimization | Track 15+ metrics; predict quality-of-hire; optimize spend |
...
Inspired by Greenhouse, Lever, Ashby, Gem. Recruiting AI reduces time-to-hire by 40%.
